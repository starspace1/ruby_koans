...
class AboutIteration < Neo::Koan
  ...
  def test_each_is_a_method_on_arrays
    assert_equal true, [].methods.include?(as_name(:each)) #I don't understand this, evaluating results in error
  end
  ...
  def test_inject_will_blow_your_mind #lol
    result = [2, 3, 4].inject(0) { |sum, item| sum + item } #wat is?
